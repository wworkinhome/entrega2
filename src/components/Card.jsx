...
const Card = (loadingData, showData, weather, forecast) => {
    ...
    var forecastDate9 = "";
        ...
        if(showDate){
            ...
            iconUrl3 = url + forecast.list[1].weather[0.icon + ".png"] + ".png";
            iconUrl6 = url + forecast.list[2].weather[0.icon + ".png"] + ".png";
            iconUrl9 = url + forecast.list[3].weather[0.icon + ".png"] + ".png";
                ...
                <div className="card mb-3 mx-auto bg-dark text-light">
                    <div className="row g-0">
                        <div className="col-md-4">
                            ...
                            <img src="https://images.pexels.com/photos/12365978/pexels-photo-12365978.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className="img-fluid rounded-start" alt=""/>
                        </div>
                        <div className="col-md-8">
                            <div className="card-body text-start mt-2">
                                ...
                                <h5 className="card-text">Velocidad del viento: {(weather.wind.speed - 273.15).toFixed(1)}m/s</h5>
